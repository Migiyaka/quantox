<template>
    <div class="shop-list">
        ...
        <div class="shops columns is-multiline" v-if="shopsLoaded">
            <a class="column is-3-fullhd is-6-widescreen is-6-desktop is-6-tablet is-12-mobile" v-for="(shop, shopIndex) in shops" v-if="shopIndex < 10">
                <div class="card">
        ...
        methods: {
            ...
            shopPhotoSource(shop) {
                if (shop.venue.photos.count > 0) {
                    ...
                    return 'http://bulma.io/images/placeholders/640x480.png';
                }
            }
        }
    };
